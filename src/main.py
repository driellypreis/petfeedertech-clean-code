...
class App:
    def __init__(self, root):
        self.root = root
        self.root.title("PetFeederTech Simulator")
        ...
        self.btn_ligar = tk.Button(self.frame_display, text="Ligar/Desligar", command=self.pressionar_botao, font=("Arial", 14, "bold"), bg="#d0f0c0")
    ...
    def agendar(self):
        ...
        if len(horario_str) != 4 or not horario_str.isdigit():
            self.update_status("Formato inválido (ex: 1630)")
            return
        try:
